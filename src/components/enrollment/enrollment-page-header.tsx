...
export default function EnrollmentPageHeader({
  ...
  const menuItems = [
    {
      href: Routes.enrollment.editByIdWithoutLang(enrollmentId),
      label: 'Info',
    },
    {
      href: Routes.enrollment.payments(enrollmentId),
      label: 'Payments',
    },
  ];
  ...
  return (
    <>
      ...
      <div className="relative mb-9 flex items-center overflow-hidden border-b border-border-base/90 lg:mb-5">
        {/* <button
          title="Prev"
          ref={sliderPrevBtn}
