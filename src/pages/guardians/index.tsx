...
export default function Guardians() {
  ...
  const { guardians, paginatorInfo, loading, error } = useGuardiansQuery({
    limit: 20,
    page,
    name: searchTerm,
    orderBy,
...
Guardians.authenticate = {
  permissions: adminOnly,
};
Guardians.Layout = Layout;
