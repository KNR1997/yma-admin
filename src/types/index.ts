...
export interface CreateAdmissionPaymentInput {
  student_id: number;
  admission?: number;
}
...
export interface AdmissionPaymentQueryOptions extends QueryOptions {}
...
export interface RolesAuthorizedResponse {
  apis: Api[];
}
...
export interface AudtiLogPaginator extends PaginatorInfo<AuditLog> {}
